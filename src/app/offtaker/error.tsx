...
/* ================================================================
   OFFTAKER ERROR BOUNDARY
   ================================================================
   Catches errors in /offtaker/* routes close to the source.
   Prevents offtaker page crashes from cascading to the root
   error boundary or global-error boundary.
   ================================================================ */

import { useEffect } from "react";

export default function OfftakerError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[OfftakerError]", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center px-6">
      ...
      <p className="text-sm text-slate-400 max-w-md mb-6">
        This page encountered an error. Your data is safe. Please try again.
      </p>
