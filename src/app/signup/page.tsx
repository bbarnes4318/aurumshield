...
/* ================================================================
   SIGNUP PAGE — Clerk Registration
   ================================================================
   Renders the Clerk <SignUp /> component so new users can create
   an account and access the institutional platform.

   Middleware marks /signup as a public route so the page loads
   without requiring an existing session. After Clerk sign-up,
   the user is redirected to /platform where the institutional
   guided journey detects new users and routes them appropriately.
   ...
   DESIGN: Visually identical to /login — institutional tone,
   same layout, same brand treatment.
        ...
        {CLERK_AVAILABLE ? (
          ...
          <div className="rounded-lg border border-[#1e293b] bg-[#0f1a2b] p-6 text-center">
            ...
            <p className="mb-4 text-sm text-[#94a3b8]">
              ...
              use the demo portal to explore the platform.
            </p>
            <Link
