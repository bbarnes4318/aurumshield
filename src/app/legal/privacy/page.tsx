  ...
  return (
    <>
      ...
      <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-8">
        ...
        <li><strong className="text-white">Banking &amp; Settlement Routing:</strong> Financial data is transmitted via secure APIs to Column Bank (and associated banking partners) to facilitate fiat capital holds, escrow locking, and final settlement routing.</li>
