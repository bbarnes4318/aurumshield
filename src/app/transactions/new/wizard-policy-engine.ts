...
export function checkBlockers(
  ...
  if (hub?.status === "degraded") b.push({ id: "hub-deg", severity: "INFO", title: "Hub Degraded", detail: `${hub.name} degraded mode.` });
...
/* ================================================================
   COMPLIANCE CHECKS — Full audit checklist for Step 3
   ================================================================ */
...
/* ================================================================
   POLICY SNAPSHOT — logged on Create
   ================================================================ */
