...
export const mockGovernanceAuditEvents: GovernanceAuditEvent[] = [
  /* ── AUTH events ── */
  {
    ...
    resourceId: "cp-001",
    ip: "10.0.2.18",
    userAgent: "Mozilla/5.0 AurumShield/3.1",
    result: "SUCCESS",
    severity: "info",
    message: "M. Reynolds authenticated successfully",
    metadata: { method: "MFA", sessionDuration: 43200 },
  },
  {
    id: "ga-002",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Admin session created for A. Reynolds",
    metadata: { ttl: 43200 },
  },
  {
    id: "ga-003",
    occurredAt: "2026-02-15T23:59:00Z",
    actorRole: "system",
    actorUserId: null,
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Session expired for user-3 after 12h TTL",
    metadata: { userId: "user-3" },
  },
  {
    id: "ga-004",
    occurredAt: "2026-02-16T07:45:00Z",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "S. Nielsen authenticated for compliance review",
    metadata: { method: "MFA" },
  },
  ...
  /* ── VERIFICATION events ── */
  {
    ...
    actorRole: "buyer",
    actorUserId: "user-1",
    action: "VERIFICATION_STEP_SUBMITTED",
    resourceType: "counterparty",
    resourceId: "cp-001",
    ip: "10.0.2.18",
    userAgent: "Mozilla/5.0 AurumShield/3.1",
    result: "SUCCESS",
    severity: "info",
    message: "KYC identity verification step submitted by M. Reynolds",
    metadata: { stepId: "kyc-id-verification", track: "INDIVIDUAL_KYC" },
    evidenceIds: ["e1"],
  },
  {
    id: "ga-006",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Verification status changed to VERIFIED for user-1",
    metadata: {
  ...
  {
    id: "ga-007",
    occurredAt: "2026-02-14T14:00:00Z",
    actorRole: "buyer",
    actorUserId: "user-3",
    action: "VERIFICATION_STEP_SUBMITTED",
    resourceType: "counterparty",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Address verification submitted by J. Tanaka",
    metadata: { stepId: "kyc-address", track: "INDIVIDUAL_KYC" },
  },
  {
    id: "ga-008",
    occurredAt: "2026-02-14T15:00:00Z",
    actorRole: "compliance",
    actorUserId: "user-6",
    action: "VERIFICATION_STATUS_CHANGED",
    resourceType: "counterparty",
    ...
    result: "DENIED",
    severity: "warning",
    message: "Verification REJECTED for user-9 — sanctions screening failed",
    metadata: {
  ...
  /* ── RESERVATION events ── */
  {
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Reservation res-001 created: 10 oz on lst-003",
    metadata: { listingId: "lst-003", weightOz: 10, expiresIn: 600 },
  },
  {
    id: "ga-010",
    occurredAt: "2026-02-15T10:00:00Z",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Reservation res-002 created: 15 oz on lst-007",
    metadata: { listingId: "lst-007", weightOz: 15, expiresIn: 600 },
  },
  {
    id: "ga-011",
    occurredAt: "2026-02-15T10:10:00Z",
    actorRole: "buyer",
    actorUserId: "user-1",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Reservation res-002 converted to order ord-001",
    metadata: { orderId: "ord-001", listingId: "lst-007" },
  },
  {
    id: "ga-012",
    occurredAt: "2026-02-14T16:00:00Z",
    actorRole: "system",
    actorUserId: null,
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Reservation res-000 expired after 10min TTL",
    metadata: { listingId: "lst-001", buyerUserId: "user-1" },
  },
  ...
  /* ── ORDER events ── */
  {
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Order ord-001 created: 15 oz @ $2,038.00/oz from lst-007",
    metadata: {
      listingId: "lst-007",
      weightOz: 15,
      notional: 30570,
  ...
  },
  {
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Order ord-002 created: 25 oz @ $2,048.50/oz from lst-001",
    metadata: {
      listingId: "lst-001",
      weightOz: 25,
      notional: 51212.5,
  ...
  {
    id: "ga-015",
    occurredAt: "2026-02-16T07:00:00Z",
    actorRole: "buyer",
    actorUserId: "user-9",
    action: "ORDER_CREATED",
    resourceType: "order",
    ...
    result: "DENIED",
    severity: "warning",
    message: "Order creation denied — user-9 verification status NOT_STARTED",
    metadata: { reason: "FORBIDDEN_ROLE", requiredStatus: "VERIFIED" },
  },

  /* ── SETTLEMENT events ── */
  {
    id: "ga-016",
    occurredAt: "2026-02-14T16:05:00Z",
    actorRole: "admin",
    actorUserId: "user-4",
    action: "SETTLEMENT_OPENED",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Settlement stl-001 opened for ord-002 — escrow initiated",
    metadata: {
      orderId: "ord-002",
      notional: 51212.5,
      weightOz: 25,
  ...
  },
  {
    ...
    actorRole: "treasury",
    actorUserId: "user-5",
    action: "SETTLEMENT_ACTION_APPLIED",
    resourceType: "settlement",
    resourceId: "stl-001",
    corridorId: "cor-002",
    hubId: "hub-001",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Funds deposited $51,212.50 for stl-001",
    metadata: { actionType: "CONFIRM_FUNDS_FINAL", amount: 51212.5 },
    ledgerEntryId: "le-002",
  },
  {
    id: "ga-018",
    occurredAt: "2026-02-14T17:00:00Z",
    actorRole: "vault_ops",
    actorUserId: "user-7",
    action: "SETTLEMENT_ACTION_APPLIED",
    resourceType: "settlement",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Gold allocated 25 oz for stl-001",
    metadata: { actionType: "ALLOCATE_GOLD", weightOz: 25 },
    ledgerEntryId: "le-003",
  },
  {
    id: "ga-019",
    occurredAt: "2026-02-14T17:15:00Z",
    actorRole: "compliance",
    actorUserId: "user-6",
    action: "SETTLEMENT_ACTION_APPLIED",
    resourceType: "settlement",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Verification cleared for stl-001",
    metadata: { actionType: "CLEAR_VERIFICATION" },
    ledgerEntryId: "le-004",
  },
  {
    id: "ga-020",
    ...
    result: "SUCCESS",
    severity: "critical",
    message: "Authorization granted for stl-001 — DvP ready",
    metadata: { actionType: "AUTHORIZE", checksStatus: "PASS" },
    ledgerEntryId: "le-005",
  },
  {
    id: "ga-021",
    ...
    result: "SUCCESS",
    severity: "critical",
    message: "DvP EXECUTED for stl-001 — funds and gold released atomically",
    metadata: {
      actionType: "EXECUTE_DVP",
      fundsReleased: true,
      goldReleased: true,
    },
    ledgerEntryId: "le-006",
  },
  {
    id: "ga-022",
    occurredAt: "2026-02-15T10:10:00Z",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Settlement stl-002 opened for ord-001 — escrow initiated",
    metadata: {
      orderId: "ord-001",
      notional: 30570,
      weightOz: 15,
  ...
  },
  {
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Settlement stl-003 opened for ord-003 — escrow initiated",
    metadata: {
      orderId: "ord-003",
      notional: 102612.5,
      weightOz: 50,
    ...
    ledgerEntryId: "le-012",
  },
  {
    id: "ga-024",
    occurredAt: "2026-02-16T06:00:00Z",
    actorRole: "buyer",
    actorUserId: "user-3",
    action: "SETTLEMENT_ACTION_APPLIED",
    resourceType: "settlement",
    ...
    result: "DENIED",
    severity: "warning",
    message: "Settlement action denied — buyer role cannot execute AUTHORIZE",
    metadata: {
  ...
  {
    id: "ga-025",
    occurredAt: "2026-02-15T16:00:00Z",
    actorRole: "admin",
    actorUserId: "user-4",
    action: "SETTLEMENT_ACTION_APPLIED",
    resourceType: "settlement",
    ...
    severity: "warning",
    message:
      "Settlement action failed — verification not yet cleared for AUTHORIZE",
    metadata: { actionType: "AUTHORIZE", errorCode: "VERIFICATION_REQUIRED" },
  },

  /* ── RECEIPT events ── */
  {
    id: "ga-026",
    occurredAt: "2026-02-14T18:30:00Z",
    actorRole: "system",
    actorUserId: null,
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Receipt generated for order ord-002 — settlement stl-001 SETTLED",
    metadata: {
      settlementId: "stl-001",
      documentId: "AR-CLR-ord-002-stl-001-20260214",
    },
  },
  {
    id: "ga-027",
    occurredAt: "2026-02-14T19:00:00Z",
    actorRole: "admin",
    actorUserId: "user-4",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Receipt export (JSON) requested for ord-002",
    metadata: { format: "JSON", settlementId: "stl-001" },
  },
  ...
  /* ── LISTING events ── */
  {
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Listing draft created: LBMA Good Delivery Bar — 400 oz",
    metadata: { form: "bar", purity: "9999", totalWeightOz: 400 },
  },
  {
    id: "ga-029",
    occurredAt: "2026-01-22T10:31:00Z",
    actorRole: "seller",
    actorUserId: "user-2",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Listing lst-001 published to marketplace",
    metadata: { pricePerOz: 2048.5 },
    evidenceIds: ["e2"],
  },
  {
    id: "ga-030",
    occurredAt: "2026-01-28T06:15:00Z",
    actorRole: "seller",
    actorUserId: "user-2",
    action: "LISTING_DRAFT_CREATED",
    resourceType: "listing",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Listing draft created: COMEX-Eligible Gold Bar — 100 oz",
    metadata: { form: "bar", purity: "999", totalWeightOz: 100 },
  },
  {
    id: "ga-031",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Listing draft created: PAMP Suisse Fortuna Bar — 50 oz",
    metadata: { form: "bar", purity: "9999", totalWeightOz: 200 },
  },

  /* ── CLAIM events ── */
  {
    id: "ga-032",
    occurredAt: "2026-02-12T13:00:00Z",
    actorRole: "admin",
    actorUserId: "user-4",
    action: "CLAIM_OPENED",
    resourceType: "claim",
    ...
    severity: "warning",
    message:
      "Claim opened: Margin call non-compliance against Caspian Trade Finance",
    metadata: {
      counterpartyId: "cp-005",
      amount: 8200000,
      currency: "USD",
  ...
  {
    id: "ga-033",
    occurredAt: "2026-01-18T12:00:00Z",
    actorRole: "compliance",
    actorUserId: "user-6",
    ...
    severity: "info",
    message:
      "Claim clm-006 decided: DENIED — vendor attribution, not counterparty",
    metadata: { decision: "denied", counterpartyId: "cp-004" },
  },
  {
    id: "ga-034",
    occurredAt: "2026-02-09T10:00:00Z",
    actorRole: "admin",
    actorUserId: "user-4",
    action: "CLAIM_OPENED",
    resourceType: "claim",
    ...
    result: "SUCCESS",
    severity: "warning",
    message: "Claim opened: FX settlement mismatch with Banco del Plata",
    metadata: { counterpartyId: "cp-007", amount: 22000000, currency: "ARS" },
  },

  /* ── EXPORT events (additional) ── */
  {
    id: "ga-035",
    occurredAt: "2026-02-14T19:30:00Z",
    actorRole: "admin",
    actorUserId: "user-4",
    action: "EXPORT_REQUESTED",
    resourceType: "settlement",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Settlement packet export requested for stl-001",
    metadata: { format: "JSON", entryCount: 7 },
  },
  {
    id: "ga-036",
    ...
    severity: "info",
    message:
      "Settlement packet export requested for stl-002 (in-progress settlement)",
    metadata: { format: "JSON", entryCount: 3 },
  },
  ...
  /* ── CRITICAL events ── */
  {
    ...
    severity: "critical",
    message:
      "DvP executed — atomic delivery-versus-payment completed for stl-001",
    metadata: {
      actionType: "EXECUTE_DVP",
      fundsReleased: true,
      goldReleased: true,
  ...
  },
  {
    ...
    severity: "critical",
    message:
      "Compliance reject — settlement stl-002 cannot proceed, verification incomplete",
    metadata: {
      actionType: "REJECT",
      errorCode: "COMPLIANCE_BLOCK",
      reason: "Buyer verification not cleared",
    },
  },
  ...
  {
    id: "ga-039",
    occurredAt: "2026-02-16T09:15:00Z",
    actorRole: "vault_ops",
    actorUserId: "user-7",
    action: "LOGIN",
    resourceType: "counterparty",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "K. Okafor authenticated for vault operations",
    metadata: { method: "MFA" },
  },
  {
    id: "ga-040",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "M. Chen authenticated for treasury operations",
    metadata: { method: "MFA" },
  },
  {
    id: "ga-041",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Funds deposited $30,570.00 for stl-002",
    metadata: { actionType: "CONFIRM_FUNDS_FINAL", amount: 30570 },
    ledgerEntryId: "le-010",
  },
  {
    id: "ga-042",
    ...
    result: "SUCCESS",
    severity: "info",
    message: "Gold allocated 15 oz for stl-002",
    metadata: { actionType: "ALLOCATE_GOLD", weightOz: 15 },
    ledgerEntryId: "le-011",
  },
];

/** @deprecated Backward compat — maps old shape from GovernanceAuditEvent fixtures */
export const mockAuditEvents: AuditEvent[] = mockGovernanceAuditEvents
  .slice(0, 8)
  .map((e) => ({
    id: e.id,
    ...
    category: (e.action.startsWith("LOGIN") || e.action.startsWith("SESSION")
      ? "auth"
      : e.action === "EXPORT_REQUESTED"
        ? "export"
        : "data") as AuditEvent["category"],
  }));
...
export interface SettlementCase {
  ...
  /* ── Fee Sweep (014_fee_sweep_columns.sql) ── */
...
export const mockLedger: LedgerEntry[] = [
  /* ── stl-001 (SETTLED) full lifecycle ── */
  {
    ...
    actorRole: "admin",
    actorUserId: "user-4",
    detail: "Escrow opened for order ord-002 — 25 oz @ $2,048.50/oz",
  },
  {
    id: "le-002",
    settlementId: "stl-001",
    ...
    actorRole: "treasury",
    actorUserId: "user-5",
    detail: "Wire transfer $51,212.50 received — SWIFT ref WIR-2026-00190",
  },
  {
    id: "le-003",
    settlementId: "stl-001",
    ...
    actorRole: "vault_ops",
    actorUserId: "user-7",
    detail: "25 oz allocated from inv-001 in Zurich Custody Vault (hub-002)",
  },
  {
    id: "le-004",
    settlementId: "stl-001",
    ...
    actorRole: "compliance",
    actorUserId: "user-6",
    detail: "Buyer verification case VERIFIED — identity perimeter cleared",
  },
  {
    id: "le-005",
    settlementId: "stl-001",
    ...
    actorUserId: "user-4",
    detail:
      "AUTHORIZATION SNAPSHOT | settlementId=stl-001 orderId=ord-002 | notional=$51,212.50 weight=25oz rail=WIRE | corridorId=cor-002 settlementHubId=hub-001 vaultHubId=hub-002 | requirements=PASS | authorizedBy=user-4 role=admin authorizedAt=2026-02-14T17:30:00Z",
    snapshot: {
      checksStatus: "PASS",
      fundsConfirmed: true,
      goldAllocated: true,
  ...
  },
  {
    ...
    actorUserId: "user-4",
    detail:
      "DVP EXECUTED ATOMIC | fundsReleased=true goldReleased=true escrowClosed=true | fundsLeg: $51,212.50 released to seller org-002 via WIRE | goldLeg: 25oz title transferred to buyer org-001 | authorizationRef=le-005 | executedBy=user-4 role=admin executedAt=2026-02-14T18:00:00Z",
    snapshot: {
      checksStatus: "PASS",
      fundsConfirmed: true,
      goldAllocated: true,
  ...
  },
  {
    ...
    actorRole: "admin",
    actorUserId: "user-4",
    detail: "Settlement completed — escrow closed",
  },
  ...
  /* ── stl-002 (ESCROW_OPEN — funds+gold confirmed, verification pending) ── */
  {
    ...
    actorRole: "admin",
    actorUserId: "user-4",
    detail: "Escrow opened for order ord-001 — 15 oz @ $2,038.00/oz",
  },
  {
    id: "le-010",
    settlementId: "stl-002",
    ...
    actorRole: "treasury",
    actorUserId: "user-5",
    detail: "RTGS transfer $30,570.00 confirmed — ref RTGS-2026-00041",
  },
  {
    id: "le-011",
    settlementId: "stl-002",
    ...
    actorRole: "vault_ops",
    actorUserId: "user-7",
    detail: "15 oz allocated from inv-007 in London Clearing Centre (hub-001)",
  },
  ...
  /* ── stl-003 (ESCROW_OPEN) ── */
  {
    ...
    actorRole: "admin",
    actorUserId: "user-4",
    detail: "Escrow opened for order ord-003 — 50 oz @ $2,052.25/oz",
  },
];
